...
function ldc_like_counter_p($text="Likes: ",$post_id=NULL)
{
	...
	$ldc_return = "<span class='ldc-ul_cont' onclick=\"alter_ul_post_values(this,'$post_id','like')\" >".$text." <i class=\"icon-thumbs-up\"></i> (<span>".get_post_ul_meta($post_id,"like")."</span>)</span>";
	return $ldc_return;
}
...
function ldc_dislike_counter_p($text="dislikes: ",$post_id=NULL)
{
	...
	$ldc_return = "<span class='ldc-ul_cont' onclick=\"alter_ul_post_values(this,'$post_id','dislike')\" >".$text." <i class=\"icon-thumbs-down\"></i> (<span>".get_post_ul_meta($post_id,"dislike")."</span>)</span>";
	return $ldc_return;
}
...
function ldc_like_counter_c($text="Likes: ",$post_id=NULL)
{
	...
	$ldc_return = "<span class='ldc-ul_cont' onclick=\"alter_ul_post_values(this,'$post_id','c_like')\" >"." <i class=\"icon-thumbs-up\"></i> (<span>".get_post_ul_meta($post_id,"c_like")."</span>)</span>";
	return $ldc_return;
}
...
function ldc_dislike_counter_c($text="dislikes: ",$post_id=NULL)
{
	...
	$ldc_return = "<span class='ldc-ul_cont' onclick=\"alter_ul_post_values(this,'$post_id','c_dislike')\" >"." <i class=\"icon-thumbs-down\"></i> (<span>".get_post_ul_meta($post_id,"c_dislike")."</span>)</span>";
	return $ldc_return ;
}
